...
const EN_TEXT = {
  ...
  "陶土材质": "Terracotta texture", "现代曲线": "Modern curves", "手作节奏": "Craft rhythm", "区域灵感": "Regional inspiration",
  ...
  "南美灵感 · 现代陶土": "South America-inspired · Modern clay",
  "现代陶土": "Modern Terracotta",
  "以陶土、奶油白与现代主义弧面形成温暖秩序；该方向作为南美现代视觉灵感使用，不代表单一国家或整个南美的传统文化。": "Terracotta, cream and modernist arcs create warm order as a contemporary South America-inspired direction, without claiming to represent one country or the entire region's traditional culture.",
