...
const themePrompts = {
  ...
  worldcupOrbit: "Create a premium 9:16 Android OS theme inspired by a generic football championship final: cinematic midnight sky, a large silver-blue abstract football orbit, cool light ribbons and a distant trophy silhouette. Keep the supplied launcher layout unchanged and reskin only wallpaper and existing icons in one black-silver-cyan metallic language. No official logos, flags, team crests, player faces, brands, text or watermarks.",
  ...
  ganeshPaper: "Create a premium 9:16 Android OS theme inspired by Ganesh festival with a respectful non-literal paper-cut style: pale apricot, moss green, marigold petals, leaves, warm lamps and soft rangoli lines. Keep the supplied launcher layout unchanged and reskin only wallpaper and existing icons in a unified handmade-paper / soft-ceramic language. No religious text, brands, watermark or literal deity face/statue.",
  ...
  diwaliPaper: "Create a premium 9:16 Android OS theme for Diwali / Festival of Lights in a bright paper-cut direction: coral, peach, soft lilac and warm gold, a floating rangoli flower, diya glow and lantern bokeh. Keep the supplied launcher layout unchanged and reskin only wallpaper and existing icons in a unified soft paper-cut / luminous ceramic language. No brands, religious text, watermark or official logos."
};
