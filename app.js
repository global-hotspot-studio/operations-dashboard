...
const themePrompts = {
  worldcupChampionAfterglow: "Premium abstract championship-afterglow OS theme: deep midnight indigo, warm amber, terracotta sculptural arcs and tiny restrained gold light particles. Reskin wallpaper and icon family in one tactile soft-ceramic language with subtle metallic edges; calm dark upper area and elegant negative space. Original, sophisticated and celebratory without literal sports imagery. No country identifiers, flags, footballs, trophies, teams, official marks, brands, text or watermarks.",
  worldcupChampionDawn: "Premium abstract championship-dawn OS theme: pearl white, cobalt dusk, liquid silver and a restrained coral glow, with translucent sculpted-glass and paper-cut arcs. Reskin wallpaper and icon family in one coherent light ceramic-glass language; calm, airy, refined flagship visual direction. Original and celebratory without literal sports imagery. No country identifiers, flags, footballs, trophies, teams, official marks, brands, text or watermarks.",
