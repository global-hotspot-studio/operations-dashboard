...
const themePrompts = {
  ...
  ganesh: "Premium festival artwork inspired by Ganesh celebration, expressed respectfully and non-literally through an elephant-inspired decorative silhouette, marigold flowers, warm lamps, leaves and rangoli geometry. Use deep indigo, saffron and muted gold with rich layered texture, balanced negative space and a refined contemporary Indian craft aesthetic. No religious text, brands, watermark or literal deity face or statue.",
  ...
  diwaliPaper: "Bright Diwali / Festival of Lights artwork in a soft paper-cut and luminous ceramic direction: coral, peach, soft lilac and warm gold; a floating rangoli flower, diya glow, lantern bokeh and layered handcrafted forms. Delicate material detail, optimistic light and an elegant contemporary composition. No brands, religious text, watermark or official logos.",
  ...
  kenyaRiftSoapstone: "Minimal premium Kenya-inspired artwork using carved soapstone ivory, tea-leaf green, warm earth brown and fine copper topographic lines. Blend Rift Valley contours, hand-carved texture and soft equatorial light into a calm modern composition with generous negative space. No wildlife clichés, flags, brands, text or watermarks.",
  nigeriaIndigoLine: "Minimal premium Nigeria-inspired artwork using near-black indigo textile, chalk white, muted brass and one confident continuous line. Add subtle woven depth and a clean Lagos-modernist rhythm while keeping the composition simple, graphic and sophisticated. No flags, literal national emblems, brands, text or watermarks.",
  southAmericaClayCurve: "Minimal premium South America-inspired artwork using terracotta, cream plaster, muted cobalt and sun-warmed modernist curves. Combine hand-shaped clay texture, architectural arcs and a small woven-color accent in a spacious contemporary composition. No landmarks, flags, brands, text or watermarks.",
